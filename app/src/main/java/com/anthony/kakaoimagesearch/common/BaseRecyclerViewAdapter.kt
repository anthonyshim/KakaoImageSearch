...
abstract class BaseRecyclerViewAdapter<T, H : RecyclerView.ViewHolder> : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        clickView.setOnClickListener(object : OnSingleClickListener() {
            override fun onSingleClick(v: View) {
                preProcessOnItemClick(holder.layoutPosition)
                onItemClickListener?.onItemClick(holder.itemView, holder.layoutPosition, this@BaseRecyclerViewAdapter)
            }
